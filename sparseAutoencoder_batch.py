...
def trainSparseAutoencoder(dataset, timesteps, input_dim, bottleneckDim, lossEvaluation, optimizer, epochs, batchSize, regularizer, verbose=False):
	...
	encoded = LSTM(bottleneckDim, activity_regularizer=regularizer)(inputs)
...
# train model
Model = trainSparseAutoencoder(dataset, timesteps, input_dim, bottleneckDim, lossEvaluation, optimizer, epochs, batchSizeModel, regularizer, verbose=2)
