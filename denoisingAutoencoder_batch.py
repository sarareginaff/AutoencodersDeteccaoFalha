...
def trainDenoisingAutoencoder(dataset, noise_factor, timesteps, input_dim, bottleneckDim, lossEvaluation, optimizer, epochs, batchSize, verbose=False):
	...
	model.fit(train_noise, train, epochs=epochs, batch_size=batchSize, verbose=verbose)
...
# train model
Model = trainDenoisingAutoencoder(dataset, noise_factor, timesteps, input_dim, bottleneckDim, lossEvaluation, optimizer, epochs, batchSizeModel, verbose=2)
